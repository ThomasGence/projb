...
def main():
    ...
    if data_args.train_file is not None or data_args.validation_file is not None:
        ...
        raw_datasets = load_dataset("wanagenst/maslow-six-choices", cache_dir=model_args.cache_dir)
    ...
    ending_names = [f"ending{i}" for i in range(6)]
    context_name = "sent1"
    ...
    def preprocess_function(examples):
        first_sentences = [[context] * 6 for context in examples[context_name]]
