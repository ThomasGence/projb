...
def main():
    ...
    if data_args.train_file is not None or data_args.validation_file is not None:
        ...
        raw_datasets = load_dataset("wanagenst/plutchik-nine-choices", cache_dir=model_args.cache_dir)
    ...
    ending_names = [f"ending{i}" for i in range(9)]
    context_name = "sent1"
    ...
    def preprocess_function(examples):
        first_sentences = [[context] * 9 for context in examples[context_name]]
        ...
        # Un-flatten
        return {k: [v[i : i + 9] for i in range(0, len(v), 9)] for k, v in tokenized_examples.items()}
